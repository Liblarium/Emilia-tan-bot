 ...
 */
export const FORBIDDEN_EXTENSIONS: Readonly<ArrayNotEmpty<string>> = [".js", ".ts", ".d.ts", ".json"];
 ...
 * Folders not allowed
 */
export const FORBIDDEN_FOLDERS: Readonly<ArrayNotEmpty<string>> = ["node_modules", "dist", "prisma", ".git", ".vscode", "types", "pgdata", "oldCode", "sandbox"];
 ...
 * Files not allowed
 */
export const FORBIDDEN_FILES: Readonly<ArrayNotEmpty<string>> = ["package.json", "package-lock.json", "tsconfig.json", "tsconfig.base.json", "biome.json"];
