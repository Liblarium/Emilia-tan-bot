import { EmiliaAbstractError } from "@constants/abstract/EmiliaAbstractError";
...
class EmiliaError {
   ...
   */
  public createError(message: string, errorType?: string, getTime?: () => string): EmiliaAbstractError {
