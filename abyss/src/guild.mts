...
//   DrawClanInfoOptions,
// } from "../types.js";
// import { TextAlignment, FontStyle } from "./enum.js";
...
//    */
//   public async registerFonts(fonts: { name: string, path: string }[]) {
...
//   /**
//    * Draws a deputy block on the canvas, with rounded corners and a gradient fill.
//    * Also draws the text inside the box with the given options.
//    *
//    * @param {DrawDeputyOptions} options - The options for drawing the deputy block.
//    * @returns {GuildProfile}
//    */
//   drawDeputy({
//     x = 470,
...
//     textOptions,
//     deputy
//   }: DrawDeputyOptions): GuildProfile {
//     const ctx = this.ctx;
...
//   const deputy: { name: string; avatar: Image; role: string }[] = [];
//   const imgDeputy = [kogasaIconImg, tenshiIconImg];
//   for (let i = 0; i < 3; i++) {
//     const indexNow = random(0, 1);
//     deputy.push({
//       name: username[indexNow],
//       avatar: imgDeputy[indexNow],
//       role: "Deputy",
//     });
//   }
...
// const deputy = [{
//   username: "Kogasa Tatara", role: "Deputy", avatar: kogasaIconImg
// }, {
//   username: "Kogasa Tatara", role: "Deputy", avatar: kogasaIconImg
// }, {
//   username: "Kogasa Tatara", role: "Deputy", avatar: kogasaIconImg
